  ...
  return (
    <motion.nav
      ...
      className={`fixed z-20 flex  w-full justify-between ${
        docType === 'home' || docType === 'about' || docType === 'production'
          ? 'text-white'
          : 'text-white'
      }`}
    >
      <div
        className={`m-3 h-max  sm:m-4 sm:mt-6  ${
          docType === 'home' || docType === 'about' || docType === 'production'
            ? 'text-white'
            : 'text-white'
        } `}
      ...
      <div
        className={`m-3 flex h-max items-center justify-center  sm:m-4   ${
          docType === 'home' || docType === 'about' || docType === 'production'
            ? 'text-white'
            : 'text-white'
        } `}
