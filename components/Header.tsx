  ...
  return (
    <header className="container mx-auto p-2">
      <div className="flex items-center justify-around">
        <Link href="">
          <img
            className="w-44 transform cursor-pointer object-contain transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
        ...
        <div className="mb-2 flex items-center">
          ...
          <div
            className="align-items z-60  ml-2 -mb-2 cursor-pointer items-center px-0 text-center sm:ml-8 sm:mb-0 sm:mr-8 sm:flex"
            onClick={toggle}
          >
