...
export default function Header() {
  ...
  return (
    <header className=" mx-auto max-w-screen-lg p-2 py-4">
      <div className="flex items-center justify-between">
        <Link href="">
          <img
            className="w-44 transform cursor-pointer object-contain px-4 transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 sm:mx-8"
        ...
        <div className=" flex items-center md:mt-4">
          ...
          {/* <div className='flex justify-center items-center lg:p-2 lg:mx-4'>
              <button
                className={`mx-1 lg:mx-2 w-8 h-8 pb-2  transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110 tracking-wide ${
                  lang == 'po'
                    ? 'font-bold border-solid align-items center border-2 border-black rounded-full  '
                    : 'font-bold border-solid align-items center border-2 border-black rounded-full '
                }`}
          ...
          <div
            className="align-items z-60 -mb-2  ml-2 cursor-pointer items-center px-0 text-center sm:mb-2 sm:ml-8 sm:mr-8 sm:flex"
            onClick={toggle}
          >
            <Hamburger rounded={true} toggled={isOpen} toggle={toggle} />
          </div>
        </div>
      </div>
    </header>
